...
export type LaunchpadsQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchpadsQuery = { __typename?: 'Query', launchpads?: Array<{ __typename?: 'Launchpad', id?: string | null | undefined, name?: string | null | undefined, status?: string | null | undefined, location?: { __typename?: 'Location', name?: string | null | undefined, region?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined };


export const LaunchpadsDocument = gql`
    query launchpads {
  launchpads {
    id
    name
...
/**
 * __useLaunchpadsQuery__
 *
 * To run a query within a React component, call `useLaunchpadsQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchpadsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchpadsQuery({
 *   variables: {
 *   },
 * });
 */
export function useLaunchpadsQuery(baseOptions?: Apollo.QueryHookOptions<LaunchpadsQuery, LaunchpadsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LaunchpadsQuery, LaunchpadsQueryVariables>(LaunchpadsDocument, options);
      }
export function useLaunchpadsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchpadsQuery, LaunchpadsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaunchpadsQuery, LaunchpadsQueryVariables>(LaunchpadsDocument, options);
        }
export type LaunchpadsQueryHookResult = ReturnType<typeof useLaunchpadsQuery>;
export type LaunchpadsLazyQueryHookResult = ReturnType<typeof useLaunchpadsLazyQuery>;
export type LaunchpadsQueryResult = Apollo.QueryResult<LaunchpadsQuery, LaunchpadsQueryVariables>;